...
**5. Regions** 
- Paritioned parquet files at `s3://public-overturemaps/hex/regions/**`
- Columns: `id`, `country`, `region` (ISO: 'US-CA'), `name`, `h8`, `h0`
- Use only when user explicitly requests regional breakdown

## Protected Areas

**6. Protected Areas (WDPA)** 
- Paritioned parquet files at: `s3://public-wdpa/hex/**`
